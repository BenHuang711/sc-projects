...
This is the frontend. User can search the name and the graphics
will show the name and the ranking chronologically.
"""
...
def draw_names(canvas, name_data, lookup_names):
    ...
    for name in lookup_names:  # (e.g. lookup_names = [kylie, nick, andy])
        ...
        for year_index in range(len(YEARS)-1):  # 12 runs
            if year_index != len(YEARS)-1:  # !
                ...
                canvas.create_text(x1+TEXT_DX, y1, text = name + all_its_text[year_index], anchor=tkinter.SW)
